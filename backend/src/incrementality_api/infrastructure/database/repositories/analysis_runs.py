...
def to_analysis_run_model(
    ...
    return AnalysisRunModel(
        ...
        analysis_period_snapshot_json=(
            run.analysis_period_snapshot.canonical_json
        ...
        estimand_snapshot_json=(
            run.estimand_snapshot.canonical_json
...
def to_analysis_run(
    ...
    return AnalysisRun(
        ...
        dataset_checksum_sha256=model.dataset_checksum_sha256,
        ...
        estimand_snapshot=(
            EstimandSnapshot.from_json(model.estimand_snapshot_json)
            if model.estimand_snapshot_json is not None
            else None
        ),
